        ...
        <div className='flex flex-col items-center'>
          ...
          >
            ...
            className='max-w-2xl mx-auto font-Ovo'>
              A passionate IT undergraduate with 1 year of software development experience. 
              Eager to leverage strong foundational skills to create efficient, user-friendly software solutions.
            </motion.p>
            <div className='flex flex-col sm:flex-row items-center gap-4 mt-4'>
              ...
              href="/Kusal_Nayanajith_SE.pdf" download 
