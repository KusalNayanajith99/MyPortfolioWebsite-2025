        ...
        className='flex w-full flex-col lg:flex-row items-center gap-20 my-20'>
            ...
            className='flex-1'>
                <p className='mb-10 max-w-2xl font-Ovo'>
                    Ambitious and results-oriented Full-Stack Developer, Enthusiastic about contributing to impactful projects 
                    by leveraging strong skills in both front-end and back-end technologies.
                </p>
