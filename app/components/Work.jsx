  ...
  return (
    ...
    id="work" className="w-full px-[12%] py-10 scroll-mt-20">
      ...
      className="text-center max-w-2xl mx-auto mt-5 mb-12 font-Ovo">
        ...
        my expertise in fullstack development.
      </motion.p>
      ...
      className="grid grid-cols-auto my-10 gap-5 dark:text-black">
        {workData.map((project, index) => (
          ...
          transition={{duration:0.3}}
            key={index}
            className="aspect-square w-full min-h-[300px] bg-no-repeat bg-cover bg-center rounded-lg relative cursor-pointer group"
          ...
          >
            ...
            flex items-center justify-between duration-500 group-hover:bottom-7">
              ...
              aspect-square flex items-center justify-center shadow-[2px_2px_0px_#000]
